    ...
    $.fn.Tabledit = function(options) {
        ...
        var Delete = {
            ...
            submit: function(td) {
                ...
                var secondRow = table.rows[id]; // second rows
                // Send AJAX request to server.
                ...
                var ajaxResult = send_ajax_delete_request(secondRow.classList[0]);
                if (ajaxResult === false) {
                    return;
                }
                // Add class "deleted" to row.
                console.log($(td).parent('tr').classList);
         ...
         * @param {string} action
         */
        function send_ajax_delete_request(user){
           /* $.ajaxSetup({
                data: {
            ...
            $.ajax({
                type: "GET",
                url: '/panel/delete_group_user/',
                data: {
                    'username':user,
                    'group': document.getElementById('group_name').innerHTML
                },
                dataType: "json",
